const tasksDB = {
    1: [
            { text: "Решите уравнение 3x+5+(x+5) = (1−x)+4", answer: "-1", exp: "Раскрываем скобки и вычислям: 3x+x+x = 1+4−5−5 ; 5x=−5 ; x=−1" }
    ],
    2: [
            { text: "Решите уравнение 2−3(2x+2) = 5−4x", answer: "-4,5", exp: "Раскрываем скобки и считаем: 2−3(2x+2)=5−4x ; 2−6x−6 = 5−4x ; x=−4,5" }
    ],
    3: [
...
function checkAnswer() {
    ...
    if (userAnswer === currentTask.answer) {
        ...
        resultBox.innerText = "Не правильно. Попробуй еще раз.";
